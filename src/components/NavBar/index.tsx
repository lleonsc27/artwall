...
const NavBar: React.FC = () => {
    ...
    return (
        <header className="header">
            ...
            <div className={`toggle-menu ${isOpen ? 'active' : ''}`} onClick={toggleMenu}>
            ...
            <nav className={`menu-nav ${isOpen ? 'show' : ''}`}>
                <ul className="menu">
                    ...
                    <li><a className='item-menu' href="#produtos">Produtos</a></li>
                    <li><a className='item-menu' href="#sobre-nos">Sobre Nós</a></li>
